...
Public Class Proton_Vpn
    ...
    Private Sub Proton_Vpn_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Label6_Click(sender As Object, e As EventArgs) Handles Label6.Click
        MsgBox("La funzione del download non è disponibile in questo software, verrai indirizato al sito ufficiale di Proton Vpn per il Download")
        Process.Start("https://protonvpn.com/it/")
    End Sub
