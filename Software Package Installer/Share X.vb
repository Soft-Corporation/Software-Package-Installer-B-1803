...
Public Class Share_X
    ...
    Private Sub Share_X_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Panel7.Hide()
    ...
    Private Sub Label6_Click(sender As Object, e As EventArgs) Handles Label6.Click
        ...
        Panel1.Hide()
        Timer1.Start()
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_348a1d5d949e450f844fa49c3698a91e.zip"), TextBox1.Text)
    End Sub
