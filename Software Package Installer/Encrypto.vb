...
Public Class Encrypto
    ...
    Private Sub Encrypto_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Panel7.Hide()
    ...
    Private Sub Label6_Click(sender As Object, e As EventArgs) Handles Label6.Click
        ...
        Panel1.Hide()
        Timer1.Start()
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_64c33330652f4d7db31286ca483af25b.zip"), TextBox1.Text)
    End Sub
